...
public interface UserService {
    ...
    /*注册*/
    void RegisterUserCount(@Param("Phone") String Phone,@Param("Password") String Password,@Param("Name")String Name,@Param("Sex") String Sex,@Param("Address") String Address);
    /*根据用户ID查询出可收取的所有的快递*/
